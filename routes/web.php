...
Route::get('/macso', function () {
    return view('frontend.home_macso');
});
...
Route::get('venta-casas','FrontendController@sales');
Route::get('es/venta-casas','FrontendController@sales');
Route::get('en/sale-houses','FrontendController@sales');
