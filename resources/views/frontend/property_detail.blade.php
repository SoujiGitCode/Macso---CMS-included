   ...
   <div class="container">
      <div class="row">
                        ...
                        <div class="pro-details-condition">
                           ...
                           <div class="pro-details-condition-inner ">
                              <ul class="condition-list">
                                 <li><i class="md-icon area"></i> <?php echo ($lang == 'es') ? 'Área':'Area';?>: <?php echo $property->area;?> (sqft) </li>
                                 ...
                                 <?php
                                    if($property->amenities!=""){
                                     ...
                                     for ($c = 1; $c <= substr_count($property->amenities, ','); $c++) {
                                       ...
                                       //  echo ' <li>'.trim($get_amenities->name).'</li>';
         ...
         <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            ...
            @if($property->url_turno!="")
            <h6><?php echo ($lang == 'es') ? 'Agendá una cita':'Make an appointment';?></h6>
            <p><?php echo ($lang == 'es') ? 'Seleccioná una fecha-hora y confirmá tu turno para ponerte en contacto con nosotros.':'Select a date and time confirm your turn to contact us.';?></p>
            <iframe id="framebody" frameborder="no" border="0" scrolling="yes" width="80%" height="580px" src="<?php echo $property->url_turno;?>"></iframe>
            @endif
         </div>
      </div>
   </div>
            ...
            <div class="flat-item">
               ...
               <div class="flat-item-info">
                  <div class="flat-title-price">
                     <h5><a href="<?php echo ($lang == 'es') ?  url('es/'.$rs->url) : url('en/'.$rs->url_en);?>"><?php echo ($lang == 'es') ? $rs->title:$rs->title_en;?></a></h5>
