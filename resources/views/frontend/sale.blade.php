      ...
      <div class="row">
         ...
         <div class="col-md-12 ">
            <div class="breadcrumbs">
               <h2 class="breadcrumbs-title wow fadeInUp" data-wow-delay="0.2s"><?php echo ($lang == 'es') ? $section->title: $section->title_en;?></h2>
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-12">
                         ...
                         <div class="col-md-3 col-sm-4 col-xs-12">
                           <select class="custom-select-box " id="bedroom">
                              ...
                              <option value="1">1 <?php echo ($lang == 'es') ? 'Dormitorio':'Bedroom';?></option>
                              <option value="2">2 <?php echo ($lang == 'es') ? 'Dormitorios':'Bedrooms';?></option>
                              <option value="3">3 <?php echo ($lang == 'es') ? 'Dormitorios':'Bedrooms';?></option>
                              <option value="4">4 <?php echo ($lang == 'es') ? 'Dormitorios':'Bedrooms';?></option>
                              <option value="5">5 <?php echo ($lang == 'es') ? 'Dormitorios':'Bedrooms';?></option>
                              <option value="6">6 <?php echo ($lang == 'es') ? 'Dormitorios':'Bedrooms';?></option>
                              <option value="7">7 <?php echo ($lang == 'es') ? 'Dormitorios':'Bedrooms';?></option>
                              <option value="8">8 <?php echo ($lang == 'es') ? 'Dormitorios':'Bedrooms';?></option>
                              <option value="9">9 <?php echo ($lang == 'es') ? 'Dormitorios':'Bedrooms';?></option>
                              <option value="10">10 <?php echo ($lang == 'es') ? 'Dormitorios':'Bedrooms';?></option>
                           </select>
                        </div>
                        <div class="col-md-3 col-sm-4 col-xs-12">
                           <select class="custom-select-box " id="bathroom">
                              <option value="0"><?php echo ($lang == 'es') ? 'Baños':'Bathrooms';?></option>
                              <option value="1">1 <?php echo ($lang == 'es') ? 'Baño':'Bathroom';?></option>
                              <option value="2">2 <?php echo ($lang == 'es') ? 'Baños':'Bathrooms';?></option>
                              <option value="3">3 <?php echo ($lang == 'es') ? 'Baños':'Bathrooms';?></option>
                              <option value="4">4 <?php echo ($lang == 'es') ? 'Baños':'Bathrooms';?></option>
                              <option value="5">5 <?php echo ($lang == 'es') ? 'Baños':'Bathrooms';?></option>
                              <option value="6">6 <?php echo ($lang == 'es') ? 'Baños':'Bathrooms';?></option>
                              <option value="7">7 <?php echo ($lang == 'es') ? 'Baños':'Bathrooms';?></option>
                              <option value="8">8 <?php echo ($lang == 'es') ? 'Baños':'Bathrooms';?></option>
                              <option value="9">9 <?php echo ($lang == 'es') ? 'Baños':'Bathrooms';?></option>
                              <option value="10">10 <?php echo ($lang == 'es') ? 'Baños':'Bathrooms';?></option>
                           </select>
                        </div>
                        <div class="col-md-3 col-sm-4 col-xs-12">
               ...
               <ul class="breadcrumbs-list">
                  ...
                  <li><?php echo ($lang == 'es') ? $section->title: $section->title_en;?></li>
               </ul>
            </div>
         </div>
         @endif
