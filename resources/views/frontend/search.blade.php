      ...
      <div class="row">
         ...
         <div class="col-md-12 ">
            <div class="breadcrumbs">
               <h2 class="breadcrumbs-title wow fadeInUp" data-wow-delay="0.2s"><?php echo ($lang == 'es') ? 'PROPIEDADES':'PROPERTIES';?></h2>
...
<?php echo Html::script('frontend/js/properties_search.js?v='.time())?>
@stop