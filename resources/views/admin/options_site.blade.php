...
<div class="row" ng-app="myApp" ng-controller="opciones">
   ...
   <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="card mb-30">
         <div class="card-header d-flex justify-content-between align-items-center">
            <h3>Actualiza aquí el logo  del sitio (Color)</h3>
         </div>
         <div class="card-body">
            <div class="row">
   ...
   <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="card mb-30">
         <div class="card-header d-flex justify-content-between align-items-center">
            <h3>Actualiza aquí el logo del sitio (Blanco)</h3>
         </div>
            ...
            <div class="row">
               <div class="col-md-8 col-sm-8 col-xs-12 text-center">
                  ...
                  <div id="dropzone-1" class="dropzone" style="min-height: 150px"></div>
                   <p style="color: #fff">Suelta tu imagen aquí. 1 MB de tamaño máximo permitido</p>
               </div>
               <div class="col-md-4 col-sm-4 col-xs-12">
