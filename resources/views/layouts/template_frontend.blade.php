   ...
   <body>
      ...
      <header class="header-area header-wrapper">
         ...
         <ul class="main-menu hidden-md hidden-sm hidden-lg" id="menu-mobile" style="display: none;">
            ...
            @foreach($menu as $rs)
            <li class="li-nav" >
               <a href="<?php echo ($lang == 'es') ? $rs->url : $rs->url_en ;?>"> <?php echo ($lang == 'es') ? $rs->title : $rs->title_en ;?></a>
            </li>
            @endforeach
            </li>
         </ul>
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="sticky-logo">
                           <a href="<?php echo url('/')?>/<?php echo $lang;?>">
                           <img src="<?php echo url('/')?>/uploads/<?php echo $site->image_1?>" alt="<?php echo ucwords ($site->name)?>">
                           </a>
                        </div>
                        <nav id="primary-menu">
                           <ul class="main-menu">
                              <?php   $menu=DB::table('menus')->where('status','1')->orderBy('position', 'asc')->get(); ?>
                              @foreach($menu as $rs)
                              <li class="li-nav @if($rs->id==3 or $rs->id==4 or $rs->id==5) mega-parent @endif" >
                                 <a href="<?php echo ($lang == 'es') ? $rs->url : $rs->url_en ;?>"> <?php echo ($lang == 'es') ? $rs->title : $rs->title_en ;?></a>
                                 ...
                                 <div class="mega-menu-area">
                                    <ul class="single-mega-item">
                                       <li onclick="window.location='<?php echo ($lang == 'es') ? url('venta-casas'): url('en/sale-houses');?>'">
                                          <a href="<?php echo ($lang == 'es') ? url('venta-casas'): url('en/sale-houses');?>"><?php echo ($lang == 'es') ? 'Casas' : 'Houses' ;?></a>
                                       </li>
                                       <li onclick="window.location='<?php echo ($lang == 'es') ? url('venta-apartamentos'): url('en/sale-apartments');?>'">
                                          <a href="<?php echo ($lang == 'es') ? url('venta-apartmentos'): url('en/sale-apartments');?>"><?php echo ($lang == 'es') ? 'Apartamentos' : 'Apartments' ;?></a>
                                       </li>
                                    </ul>
                                 </div>
                                 @endif
                                ...
                                @if($rs->id==4)
                                    <!-- Alquiler -->
                                      <div class="mega-menu-area">
                                          <ul class="single-mega-item">
                                              <li onclick="window.location='<?php echo ($lang == 'es') ? url('alquiler-casas'): url('en/rental-houses');?>'">
                                              <a href="<?php echo ($lang == 'es') ? url('alquiler-casas'): url('en/rental-houses');?>"><?php echo ($lang == 'es') ? 'Casas' : 'Houses' ;?></a>
                                              </li>
                                              <li onclick="window.location='<?php echo ($lang == 'es') ? url('alquiler-apartamentos'): url('en/rental-apartments');?>'">
                                               <a href="<?php echo ($lang == 'es') ? url('alquiler-apartamentos'): url('en/rental-apartments');?>"><?php echo ($lang == 'es') ? 'Apartamentos' : 'Apartments' ;?></a>
                                              </li>
                                          </ul>
                                      </div>
                                  @endif
                                  ...
                                  @if($rs->id==5)
                                      ...
                                      <div class="mega-menu-area">
                                          <ul class="single-mega-item">
                                              <li onclick="window.location='<?php echo ($lang == 'es') ? url('invercion-casas'): url('en/investment-houses');?>'">
                                                  <a href="<?php echo ($lang == 'es') ? url('invercion-casas'): url('en/investment-houses');?>"><?php echo ($lang == 'es') ? 'Casas' : 'Houses' ;?></a>
                                              </li>
                                              <li onclick="window.location='<?php echo ($lang == 'es') ? url('invercion-apartamentos'): url('en/investment-apartments');?>'">
                                                  <a href="<?php echo ($lang == 'es') ? url('invercion-apartamentos'): url('en/investment-apartments');?>"><?php echo ($lang == 'es') ? 'Apartamentos' : 'Apartments' ;?></a>
                                              </li>
                                          </ul>
                                      </div>
                                  @endif
