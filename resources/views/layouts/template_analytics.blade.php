...
<html lang="es">
   <head>
      ...
      <?php echo Html::style('backend/css/morris.css')?>
      <!-- Plugins css Ends-->
      <!-- App css-->
      ...
      <?php echo Html::script('backend/js/raphael-min.js')?>
      <?php echo Html::script('backend/js/sparkline.js')?>
 <?php echo Html::script('backend/js/morris.min.js')?>
   </head>
   <body>
      <div id="mask">
         <div class="loader-p">
      ...
      <?php echo Html::script('backend/js/function_uploads.js')?>
      <?php echo Html::script('backend/js/ajaxupload.js');?>
      <?php echo Html::script('backend/js/ckeditor/ckeditor.js')?>
      <?php echo Html::script('backend/js/config_editor.js')?>
